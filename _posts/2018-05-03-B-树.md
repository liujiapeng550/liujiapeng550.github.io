...
![image](https://mypicgo-1256286372.cos.ap-guangzhou.myqcloud.com/img/640)
节点3，5已经是两元素节点，无法再增加。父亲节点 2， 6 也是两元素节点，也无法再增加。根节点9是单元素节点，可以升级为两元素节点。于是拆分节点3，5与节点2，6，让根节点9升级为两元素节点4，9。节点6独立为根节点的第二个孩子。![image](https://mypicgo-1256286372.cos.ap-guangzhou.myqcloud.com/img/640)
## 删除
自顶向下查找元素11的节点位置。
![image](https://mypicgo-1256286372.cos.ap-guangzhou.myqcloud.com/img/640)
删除11后，节点12只有一个孩子，不符合B树规范。因此找出12,13,15三个节点的中位数13，取代节点12，而节点12自身下移成为第一个孩子。（这个过程称为左旋）![image](https://mypicgo-1256286372.cos.ap-guangzhou.myqcloud.com/img/640)![image](http://mmbiz.qpic.cn/mmbiz_jpg/NtO5sialJZGrbI83f8meYn1UlzibHGBcqRbDOA2SYhksUO3BlibgZciauxcTZFfXobCnFwPegUjLHYqwq4CW7gTYGg/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1)