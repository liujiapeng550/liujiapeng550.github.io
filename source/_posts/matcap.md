...
例如下图图二（黑白）中，球形就是Matcap贴图，箭头代表了右下朝向的法线，车与人的模型法线朝
向此相同方向时，就会渲染为球形贴图上相应点的颜色——白色。

![1](/images/matcap/1.png)



![image](/images/matcap/image-20220426162350052.png)
...
![image-20220426163810853](/images/matcap/image-20220426163810853.png)

![image-20220426164202117](/images/matcap/image-20220426164202117.png)

 ![image-20220426192939550](/images/matcap/image-20220426192939550.png)
...
2. 曲面会将图片拉伸（如圆柱体身）
 ...
 ![image.png](/images/matcap/error.png)

#### 1.计算模型曲率

![img](/images/matcap/v2-7e560a07f7548bf554e4050348294c30_720w.jpg)

![image](/images/matcap/image-20220427114732596.png)
...
![image-20220427114848590](/images/matcap/image-20220427114848590.png)

#### 2.根据曲率不同，修正法线

曲率越小，采样向量越趋近修正结果（反向光线向量），曲率越大，采样结果越趋近法向量。

![image-20220427183158393](/images/matcap/image-20220427183158393.png)

得到看起来正确的效果:

![image-20220427195206177](/images/matcap/image-20220427195206177.png)


###  2.边缘采样问题

### 问题：当平移相机时，球体边缘采样错误
![bug](/images/matcap/bug.png)
...
![img](/images/matcap/v2-694610bcacddefb69c99135dca762ba8_720w.jpg)
...
![img](/images/matcap/v2-8c35fafc09bd2c7c4b0b6aa5f97d0a69_720w.jpg)

首先我们先拿到camera 坐标系的三个坐标轴在世界空间的向量。

![image-20220427174303567](/images/matcap/image-20220427174303567.png)

![image-20220427181941363](/images/matcap/image-20220427181941363.png)
...
![matcap_n](/images/matcap/matcap_n.png)

修改法线贴图rg通道值，注意修改完rg通道后需要修正z值

![image-20220426161239833](/images/matcap/image-20220426161239833.png)
<img src="./images/matcap/image-20220420145729574.png" alt="image-20220420145729574" style="zoom:50%;" />
...
![POPO-screenshot-20220525-112924](/images/matcap/POPO-screenshot-20220525-112924.png)
